...
DROP TABLE #bbc
CREATE TABLE #bbc (DatabaseName VARCHAR(100),ObjectName VARCHAR(100),Index_id int, indexName VARCHAR(100),avg_fragmentation_percent FLOAT,IndexType VARCHAR(100),Action_Required VARCHAR(100) DEFAULT 'NA')
GO
